...
#endif
''',
    "esp_http_client.h": r'''// Stub of ESP-IDF esp_http_client.h, materialized by check-includes from esp_stubs.py.
#pragma once
...
#define ESP_ERR_HTTP_MAX_REDIRECT (ESP_ERR_HTTP_BASE + 3)
#define ESP_ERR_HTTP_CONNECT (ESP_ERR_HTTP_BASE + 6)
