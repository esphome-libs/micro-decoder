...
public:
    ...
    /// set, after stopping any active playback. Returns false (and transitions to FAILED) on
    ...
    /// (AudioFileType::NONE), leaving the state unchanged. Returns false if no listener is set,
